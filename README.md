...
> Anti-Entropator is a local-first Rust data lakehouse CLI
> under active v0.3 stabilization. Core local workflows are available, while
> some commands and release-hardening tasks are still being finalized. See the
> roadmap and security notes for current status.
----
